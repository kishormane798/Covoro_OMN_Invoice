...
function applyTaxCategoryDependents(
  ...
  if (taxCategory === FV.STANDARD_TAX_CATEGORY_CODE) {
    ...
    next[FV.TAX_EXEMPTION_REASON_CHARGES_FIELD] = "";
    next[FV.TAX_EXEMPTION_REASON_ALLOWANCES_FIELD] = "";
    return next;
  }
  ...
  if (taxCategory === FV.EXEMPT_FROM_TAX_TAX_CATEGORY_CODE) {
    ...
    next[FV.TAX_EXEMPTION_REASON_CHARGES_FIELD] = FV.TAX_EXEMPTION_REASON_SAMPLE;
    next[FV.TAX_EXEMPTION_REASON_ALLOWANCES_FIELD] =
