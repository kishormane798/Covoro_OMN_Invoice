...
export const countryValidTestData = [
  ...
  { label: "Australia" },
  { label: "Aruba" },
  // Template Masters!V stores UTF-8-as-Latin-1 (ISO: Åland Islands).
...
export const unitOfMeasurementValidTestData = [
  ...
  // Template Masters!AH stores UTF-8-as-Latin-1 (ISO had U+00A0 / U+00BA / quotes / en-dash).
  { label: "British thermal unit (international table) foot per hour\u00C2 square foot degree Fahrenheit" },
  { label: "British thermal unit (international table) inch per hour square\u00C2 foot degree Fahrenheit" },
  { label: "British thermal unit (international table) inch per second square\u00C2 foot degree Fahrenheit" },
  ...
  { label: "British thermal unit (thermochemical) foot per hour square\u00C2 foot degree Fahrenheit" },
  { label: "British thermal unit (thermochemical) per hour" },
  { label: "British thermal unit (thermochemical) inch per hour square\u00C2 foot degree Fahrenheit" },
  { label: "British thermal unit (thermochemical) inch per second\u00C2 square foot degree Fahrenheit" },
  ...
  { label: "megawatt hour (1000\u00C2 kW.h)" },
  { label: "pen calorie" },
  { label: "pound foot per second" },
  { label: "pound inch per second" },
  { label: "Pferdestaerke" },
  { label: "centimetre of mercury (0 \u00C2\u00BAC)" },
  { label: "centimetre of water (4 \u00C2\u00BAC)" },
  { label: "foot of water (39.2 \u00C2\u00BAF)" },
  { label: "inch of mercury (32 \u00C2\u00BAF)" },
  { label: "inch of mercury (60 \u00C2\u00BAF)" },
  { label: "inch of water (39.2 \u00C2\u00BAF)" },
  { label: "inch of water (60 \u00C2\u00BAF)" },
  ...
  { label: "British thermal unit (39 \u00C2\u00BAF)" },
  { label: "British thermal unit (59 \u00C2\u00BAF)" },
  { label: "British thermal unit (60 \u00C2\u00BAF)" },
  { label: "calorie (20 \u00C2\u00BAC)" },
  ...
  { label: "Pallet ISO 2 \u00E2\u0080\u0093 2/1 EURO Pallet" },
  { label: "Block" },
  ...
  { label: "Unit" },
  { label: "Vat" },
  { label: "Bulk, gas (at 1031 mbar and 15\u00C2\u00B0C)" },
  { label: "Vial" },
  { label: "Vanpack" },
  { label: "Bulk, liquid" },
  { label: "Bulk, solid, large particles (\u00E2\u0080\u009Cnodules\u00E2\u0080\u009D)" },
  { label: "Vacuum-packed" },
  { label: "Bulk, liquefied gas (at abnormal temperature/pressure)" },
  { label: "Vehicle" },
  { label: "Bulk, solid, granular particles (\u00E2\u0080\u009Cgrains\u00E2\u0080\u009D)" },
  { label: "Bulk, scrap metal" },
  { label: "Bulk, solid, fine particles (\u00E2\u0080\u009Cpowders\u00E2\u0080\u009D)" },
...
export const fieldSectionMap: Record<string, string> = {
  ...
  "Scheme Identifier - Payment": "payment",
