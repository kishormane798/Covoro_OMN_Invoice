...
const SUITES = {
  ...
  excel_covoro_field_formula: {
    ...
    project: 'chromium',
    specs: [
      'tests/FieldValidation_CovoroTemplate_Test.spec.ts',
      'tests/FormulaValidation_CovoroTemplate_Test.spec.ts',
    ],
  },
  excel_covoro_submit: {
    ...
    project: 'chromium',
    specs: [
      'tests/kishorsubmit/SubmitInvoice_CovoroTemplate_Test.spec.ts',
      'tests/kishorsubmit/SubmitInvoice_MultiItem_CovoroTemplate_Test.spec.ts',
    ],
  },
  excel_covoro_conditional: {
    ...
    mode: 'scheduled',
    project: 'chromium',
    specs: ['tests/ConditionalValidation_CovoroTemplate_Test.spec.ts'],
  },
  ui_create_invoice: {
    displayName: 'UI — Create Invoice',
    mode: 'scheduled',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIInvoiceCreation_Manual_Test.spec.ts'],
  },
  ui_edit_invoice: {
    displayName: 'UI — Edit Invoice',
    mode: 'scheduled',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIInvoiceEdit_Manual_Test.spec.ts'],
  },
  ui_copy_invoice: {
    displayName: 'UI — Copy Invoice',
    mode: 'scheduled',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIInvoiceCopy_Manual_Test.spec.ts'],
  },
  ui_submit_invoice: {
    ...
    project: 'chromium-ui',
    specs: [
      'tests/KISHOR_UI/UISubmitInvoice_Test.spec.ts',
      'tests/KISHOR_UI/UISubmitInvoice_MultiItem_Test.spec.ts',
    ],
  },
  ui_attachment_download: {
    ...
    project: 'chromium-ui',
    specs: [
      'tests/KISHOR_UI/UIInvoiceEdit_Attachment_Test.spec.ts',
      'tests/KISHOR_UI/UIInvoiceFileDownload_Test.spec.ts',
    ],
  },
  ...
  sanity_submit: {
    ...
    mode: 'manual',
    project: 'chromium',
    specs: ['tests/sanitysubmit/SubmitInvoice_Sanity_Test.spec.ts'],
  },
  ui_all: {
  ...
  ui_master: {
    ...
    mode: 'manual',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIMaster_BuyerAndItem_Test.spec.ts'],
  },
  ...
  spec_excel_covoro_field: {
    ...
    mode: 'manual',
    project: 'chromium',
    specs: ['tests/FieldValidation_CovoroTemplate_Test.spec.ts'],
  },
  spec_excel_covoro_formula: {
    displayName: 'Covoro Template Formula Validation',
    mode: 'manual',
    project: 'chromium',
    specs: ['tests/FormulaValidation_CovoroTemplate_Test.spec.ts'],
  },
  ...
  spec_excel_covoro_submit: {
    ...
    mode: 'manual',
    project: 'chromium',
    specs: ['tests/kishorsubmit/SubmitInvoice_CovoroTemplate_Test.spec.ts'],
  },
  spec_excel_covoro_submit_multi: {
    displayName: 'Covoro Template Submit Multi-Item',
    mode: 'manual',
    project: 'chromium',
    specs: ['tests/kishorsubmit/SubmitInvoice_MultiItem_CovoroTemplate_Test.spec.ts'],
  },
  spec_sanity_submit: {
  ...
  spec_ui_submit: {
    ...
    mode: 'manual',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UISubmitInvoice_Test.spec.ts'],
  },
  spec_ui_submit_multi: {
    displayName: 'UI Submit Multi-Item',
    mode: 'manual',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UISubmitInvoice_MultiItem_Test.spec.ts'],
  },
  spec_ui_attachment: {
    displayName: 'UI Attachment',
    mode: 'manual',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIInvoiceEdit_Attachment_Test.spec.ts'],
  },
  spec_ui_file_download: {
    displayName: 'UI File Download',
    mode: 'manual',
    project: 'chromium-ui',
    specs: ['tests/KISHOR_UI/UIInvoiceFileDownload_Test.spec.ts'],
  },
};
